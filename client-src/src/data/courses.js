      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'swiggy-kitchen', title: 'Build the Swiggy Backend', minutes: 40,
            ...
            src: '/java/swiggy-kitchen/index.html',
            thumbnail: '/java/swiggy-kitchen/thumb.png' },
        ],
      },
      {
        id: 'file-handling',
        ...
        lessons: [
          ...
          { id: 'alien-decoder', title: 'Alien Decoder', minutes: 20,
            ...
            thumbnail: '/java/alien-decoder/thumb.png' },
          ...
          { id: 'quiz-app', title: 'Build the Quiz App', minutes: 40,
            ...
            src: '/java/quiz-app/index.html',
            thumbnail: '/java/quiz-app/thumb.png' },
          { id: 'file-detective', title: 'File Detective', minutes: 30,
            ...
            src: '/java/file-detective/index.html',
            thumbnail: '/java/file-detective/thumb.png' },
          { id: 'songbox', title: 'SongBox', minutes: 30,
            ...
            src: '/java/songbox/index.html',
            thumbnail: '/java/songbox/thumb.png' },
          { id: 'my-expense-tracker', title: 'MyExpenseTracker', minutes: 20,
            blurb: 'The landing page for a four-class expense tracker — read the product as a class diagram: Main runs the menu, ExpenseTracker holds the list, FileManager reads and writes the file, Expense is one row of spending.',
            src: '/java/my-expense-tracker/index.html',
            thumbnail: '/java/my-expense-tracker/thumb.png' },
        ],
      },
    ],
  },
